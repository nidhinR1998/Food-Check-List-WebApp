...
public interface PaymentService {
    ...
    void updateTransactionStatus(String transactionId,String upiTxnId, String status, String updateAdvance, String username);
	String getManualConfirmation(String username, double amount, double updateAdvance);
}
