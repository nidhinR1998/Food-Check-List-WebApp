...
public class UserServiceImpl implements UserService {
	...
	public boolean getResetPasswordOTP(String username, String email) {
	    ...
	    if (user != null && user.getEmail().equals(email)) {
	        ...
	        // Use the template from ConstantsUtil and replace placeholders
	        String htmlContent = ConstantsUtil.EMAIL_TEMPLATE_RESET_PASSWPRD
	...
	public boolean isEmailValid(String email) {
		String emailRegex = ConstantsUtil.VALIED_EMAIL;
